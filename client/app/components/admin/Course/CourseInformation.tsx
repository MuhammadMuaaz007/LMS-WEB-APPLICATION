...
const CourseInformation: FC<Props> = ({
  ...
  const inputTheme =
    "w-full mt-2 px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-transparent text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500 transition-all duration-200";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            >
              ...
              <option className="bg-white dark:bg-slate-800" value="Beginner">
                Beginner
              </option>
              <option
                className="bg-white dark:bg-slate-800"
              ...
              <option className="bg-white dark:bg-slate-800" value="Expert">
                Expert
              </option>
            </select>
          </div>
            ...
            >
              {courseInfo.thumbnail ? (
                ...
                <div className="space-y-2">
                  <svg
                    className="mx-auto h-12 w-12 text-slate-400 group-hover:text-teal-500 transition-colors"
                    stroke="currentColor"
                    fill="none"
                    viewBox="0 0 48 48"
                    aria-hidden="true"
