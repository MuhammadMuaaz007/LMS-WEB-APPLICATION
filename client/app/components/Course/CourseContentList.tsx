...
const CourseContentList: FC<Props> = (props) => {
  ...
  let totalCount: number = 0; // Cumulative pointer tracking indices cleanly
  ...
  return (
    ...
    >
      {videoSections.map((section: string) => {
        ...
        // Filter and compile metrics for current section
        const sectionVideos: any[] =
          props.data?.filter((item: any) => item.videoSection === section) ||
          [];
        ...
        return (
          <div
            ...
            key={section}
          >
            {/* Accordion Header - Matches Parents Card Triggers */}
            <div
                ...
                {sectionVideos.map((item: any, index: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h5
                        className={`pl-[31px] text-[11px] font-medium tracking-wide ${
                          isActive
                            ? "text-slate-300"
