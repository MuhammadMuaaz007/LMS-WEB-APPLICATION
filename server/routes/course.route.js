...
import { uploadCourse, editCourse, getSingleCourse, getAllCourses, getCourseByUser, addQuestion, addAnswer, addReview, addReviewReply, getAllCoursesAdmin, deleteCourse, generateVideoUrl, } from "../controllers/course.controller.js";
...
courseRouter.put("/add-reply", updateAccessToken, isAuthenticated, authorizeRole("admin"), addReviewReply);
courseRouter.get("/get-all-admin-courses", updateAccessToken, isAuthenticated, authorizeRole("admin"), getAllCoursesAdmin);
